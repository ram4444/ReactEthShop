export const urls = {
  ...
  etherscan_rinkeby: 'https://api-rinkeby.etherscan.io/api?module=contract&action=getabi&address=',
  etherscan_ropsten: 'https://api-ropsten.etherscan.io/api?module=contract&action=getabi&address='
};
