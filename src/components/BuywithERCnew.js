...
function BuywithERCnew({ amountTransfer, toAddr, contractAddr, chain, currencyName, product, handleToggle, handleUnderTx, handleOnSuccess, handleOnFail}) {
